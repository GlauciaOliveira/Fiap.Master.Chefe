...
namespace Fiap.Master.Chefe.API.Controllers
{
    ...
    public class ReceitasController : Controller
    {
        ...
        public ReceitasController(MasterChefeContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Receitas
        [HttpGet]
        public IEnumerable<Core.Model.Receita> GetReceita()
        {
        ...
        // PUT: api/Receitas/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutReceita([FromRoute] int id, [FromBody] Core.Model.Receita receita)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        // POST: api/Receitas
        [HttpPost]
        public async Task<IActionResult> PostReceita([FromBody] Core.Model.Receita receita)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
